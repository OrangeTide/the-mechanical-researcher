/* test_objc.m : bare-metal ColdFire V4e test — Objective-C */
/* Cross-compile: m68k-linux-gnu-gcc -mcpu=5475 -O2 -nostdlib -static
 *   -ffreestanding -x objective-c -T link.ld */
/* Copyright (c) 2026 Jon Mayo — MIT-0 OR Public Domain */
/* Written with AI assistance (Claude, Anthropic) */

/* No ObjC runtime features — pure C subset compiled as Objective-C. */
